...
public class PanelJuego extends JPanel implements KeyListener{
     ...
     private   int  nivel=0,contJefe=0,puntos=0,velocidad=3 ,contDisparos=0,resistencias[]=new int[this.tamañoHilera],contR=0;
     private final String   hilera[]={"A","B","D","E","C","Basic"};//Nombre de las hileras
     public String   listaActual="",listaSiguiente,nombreJug;
     public final int  contDisparosHileraD[]=new int[5], tamañoHilera=5;//vector que guarda disparos de cada jugador en su posicion
  ...
  j=i+"i"+""; }
    ...
    if(nh.hilera.equals("Hilera:D")){ 
        while(true){contR=0;
            ...
            if(contR==this.tamañoHilera-1){ cont2++;
